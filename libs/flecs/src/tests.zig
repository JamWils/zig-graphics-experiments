...
test "flecs.try_different_alignments" {
    const world = ecs.init();
    defer _ = ecs.fini(world);
...
test "flecs.pairs.component-tag" {
    const world = ecs.init();
    defer _ = ecs.fini(world);
...
test "flecs.pairs.delete-children" {
    const world = ecs.init();
    defer _ = ecs.fini(world);
