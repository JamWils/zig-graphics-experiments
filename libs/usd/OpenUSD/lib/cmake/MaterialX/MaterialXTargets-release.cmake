...
set_target_properties(MaterialXCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXCore.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXCore.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXCore )
list(APPEND _cmake_import_check_files_for_MaterialXCore "${_IMPORT_PREFIX}/lib/libMaterialXCore.1.38.7.dylib" )
...
set_target_properties(MaterialXFormat PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXFormat.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXFormat.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXFormat )
list(APPEND _cmake_import_check_files_for_MaterialXFormat "${_IMPORT_PREFIX}/lib/libMaterialXFormat.1.38.7.dylib" )
...
set_target_properties(MaterialXGenShader PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXGenShader.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXGenShader.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenShader )
list(APPEND _cmake_import_check_files_for_MaterialXGenShader "${_IMPORT_PREFIX}/lib/libMaterialXGenShader.1.38.7.dylib" )
...
set_target_properties(MaterialXGenGlsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXGenGlsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXGenGlsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenGlsl "${_IMPORT_PREFIX}/lib/libMaterialXGenGlsl.1.38.7.dylib" )
...
set_target_properties(MaterialXGenOsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXGenOsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXGenOsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenOsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenOsl "${_IMPORT_PREFIX}/lib/libMaterialXGenOsl.1.38.7.dylib" )
...
set_target_properties(MaterialXGenMdl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXGenMdl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXGenMdl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMdl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMdl "${_IMPORT_PREFIX}/lib/libMaterialXGenMdl.1.38.7.dylib" )
...
set_target_properties(MaterialXGenMsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXGenMsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXGenMsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMsl "${_IMPORT_PREFIX}/lib/libMaterialXGenMsl.1.38.7.dylib" )
...
set_target_properties(MaterialXRender PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXRender.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXRender.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXRender )
list(APPEND _cmake_import_check_files_for_MaterialXRender "${_IMPORT_PREFIX}/lib/libMaterialXRender.1.38.7.dylib" )
...
set_target_properties(MaterialXRenderHw PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXRenderHw.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXRenderHw.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderHw )
list(APPEND _cmake_import_check_files_for_MaterialXRenderHw "${_IMPORT_PREFIX}/lib/libMaterialXRenderHw.1.38.7.dylib" )
...
set_target_properties(MaterialXRenderGlsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXRenderGlsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXRenderGlsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderGlsl "${_IMPORT_PREFIX}/lib/libMaterialXRenderGlsl.1.38.7.dylib" )
...
set_target_properties(MaterialXRenderMsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXRenderMsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXRenderMsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderMsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderMsl "${_IMPORT_PREFIX}/lib/libMaterialXRenderMsl.1.38.7.dylib" )
...
set_target_properties(MaterialXRenderOsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libMaterialXRenderOsl.1.38.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libMaterialXRenderOsl.1.dylib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderOsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderOsl "${_IMPORT_PREFIX}/lib/libMaterialXRenderOsl.1.38.7.dylib" )
